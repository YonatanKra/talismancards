<template>
    <div class="single-card">
        ...
        <img @mouseover="toggleTipOpen = true" 
             @mouseout="toggleTipOpen = false" 
             ref="image" slot="anchor" 
             height="90%" 
             :src="`https://talismancards.s3.us-east-2.amazonaws.com/images/${card?.fileName}`" /> 

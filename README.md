...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/u46u5HUU7U)
...
```sh
npx nx serve custom-talisman-cards
```

To create a production bundle:

```sh
npx nx build custom-talisman-cards
```

To see all available targets to run for a project, run:

```sh
npx nx show project custom-talisman-cards
```
